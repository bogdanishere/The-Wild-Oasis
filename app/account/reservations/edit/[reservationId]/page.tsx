...
import { editReservationAction } from "@/app/_lib/action";
...
export default async function Page({ params }: { params: ParamsProps }) {
  ...
  const { numGuests, observations, cabinId } = await services.getBooking(
    Number(reservationId)
  );

  const { maxCapacity } = await services.getCabin(cabinId);
